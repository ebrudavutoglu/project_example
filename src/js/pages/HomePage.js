    ...
    getProducts(){
        ...
        for (let index = 0; index < this.products.length; index++) {
            ...
            let productId = product.productId,
                ...
                productLikeCount = product.params.likeCount,
                percent = "",
                categories = "",
                likeCount = "";
            ...
            for (let i = 0; i < product.categories.length; i++) {
                ...
                categories +=  `<div class="category-item">
                                    ${category}
                                </div>`;
            ...
            //LikeCount
            if(productLikeCount){
                likeCount = `<div class="like-count">
                                <i class="icon-heart-o"></i>
                                ${productLikeCount}
                            </div>`;
            }
            
            //If Old Price get price and oldprice
            let priceDiv;
            if(oldPrice){
                priceDiv = `<div class="box-price">
            ...
            //if oldprice get percentage
            if(oldPrice){
                percent =   `<div class="percent">
                                -${Math.round(Math.abs(price * ( (100-oldPrice) / 100 )))} %
                            </div>`
            }
        
            //Div add all products
            products.innerHTML +=   `<div class="swiper-slide">
                                        <a href="${productURI}" target="_blank" class="box box-product">
                                            ...
                                            <div class="box-body">
                                                ...
                                                ${priceDiv}
                                                <small class="base-price">${basePrice}</small>
                                            </div>
                                        </a>
                                    </div>`;
        } 
